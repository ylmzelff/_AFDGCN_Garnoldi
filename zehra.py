...
class GPR_prop(MessagePassing):
    ...
    def _repr_(self):
        return '{}(K={}, temp={})'.format(self._class.__name_, self.K, self.temp)
...
class Model(nn.Module):
    def _init_(self, num_node, input_dim, hidden_dim, output_dim, embed_dim, cheb_k, horizon, num_layers, heads,
